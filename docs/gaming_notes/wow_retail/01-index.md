...
* **LOS**: Line of sight means that either you can see the objective, or an ally or enemy can see you there is a "vision" or "visible" path to reach the target with an AOE or targeted spell. For example the common expression **Break LOS** means set your character behind wall or something to become not visible